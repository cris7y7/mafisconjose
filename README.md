...
reglas para gestionar nuestro proyecto con GIT - GIT HUB:

1. nunca toques cambios directamente en main , es la version principal que esta en produccion

2. el ciclo de vida profesional (the workflow)
